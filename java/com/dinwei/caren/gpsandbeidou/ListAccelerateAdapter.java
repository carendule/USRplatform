...
public class ListAccelerateAdapter extends BaseAdapter {
    ...
    public ListAccelerateAdapter(Context context){
    ...
    @Override
    public int getCount() {
        return HistoryAccelerate.historyAccelerates.size();
    }
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        if (HistoryAccelerate.historyAccelerates.isEmpty()){
            listItemView.listtime.setText("无数据");
            listItemView.listvalue.setText("无数据");
        }else{
            listItemView.listtime.setText(unix2data(HistoryAccelerate.historyAccelerates.get(position).getChangetime()));
            listItemView.listvalue.setText(String.valueOf(HistoryAccelerate.historyAccelerates.get(position).getAccelerate()));
