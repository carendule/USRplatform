...
public class ListstressAdapter extends BaseAdapter {private Context context;
    ...
    public ListstressAdapter(Context context){
    ...
    @Override
    public int getCount() {
        return HistoryStress.historyStresses.size();
    }
    ...
    public View getView(int position, View view, ViewGroup viewGroup) {
        ...
        if (HistoryStress.historyStresses.isEmpty()){
            listItemView.listtime.setText("无数据");
            listItemView.listvalue.setText("无数据");
        }else{
            listItemView.listtime.setText(unix2data(HistoryStress.historyStresses.get(position).getChangetime()));
            listItemView.listvalue.setText(String.valueOf(HistoryStress.historyStresses.get(position).getStress()));
